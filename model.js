...
module.exports.trainModel=async function(inputs, outputs, size, window_size, n_epochs, learning_rate, n_layers, callback)
{
...
module.exports.Predict=function(inputs, model)
{
    const outps =model.predict(tf.tensor2d(inputs, [inputs.length, inputs[0].length]).div(tf.scalar(10))).mul(10);
